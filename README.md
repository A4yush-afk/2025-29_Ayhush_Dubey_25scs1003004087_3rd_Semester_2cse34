...
| **Programme** | B.Tech CSE (Cyber Security), Batch 2024–2028 |
| **Internship Domain** | Google AI-ML |
| **Duration** | 8 Weeks (June 2026 – August 2026) |
| **GitHub** | [@mohdnoorain07](https://github.com/mohdnoorain07) |

---

## 📌 About the Internship

The internship focused on building a strong practical foundation in Machine Learning and Deep Learning using **TensorFlow**, applied to real-world computer-vision problems — image classification, on-device object detection, and product image search for mobile applications. It followed a structured, week-wise curriculum combining conceptual learning, hands-on labs, quizzes, and skill badges on the Google Developer Program platform, culminating in a Final Credential Validation.

**Organization:** EduSkills Academy (ISO 9001:2015 & ISO/IEC 20000-1:2018 certified) — runs the AICTE–EduSkills Virtual Internship Program under the patronage of the **AICTE National Internship Portal**, in partnership with **Google for Developers**.
...
- Train custom object-detection models with TensorFlow Lite & Model Maker
...
- Build backend integration for a product image search mobile app
...
| Field | Details |
|---|---|
| **Certificate Title** | Certificate of Virtual Internship – Google AI-ML |
| **Grade** | O (Outstanding) |
| **Certificate ID** | `47c1b5a2db80b5b4d30a` |
| **AICTE Student ID** | `STU699ab8dc3a2f41771747548` |
| **Offer Letter Ref No.** | `C17Y2026M081461697` |
...
```
├── Internship_Report_Mohd_Noorain.docx     # Full internship report (AICTE/IILM format)
├── Google_AI_ML_Internship_Noorain.pptx    # Presentation deck
...
Thanks to the AICTE–EduSkills Virtual Internship Program team, EduSkills Academy, and Google for Developers for the opportunity, and to IILM University, Greater Noida for continuous support throughout the programme.

---

**Mohd Noorain** · B.Tech CSE (Cyber Security) · IILM University, Greater Noida
